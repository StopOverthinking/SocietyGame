const SITUATIONS = [
    ...
    },
    {
        ...
        choices: [
            { 
                text: '단열 효과가 좋은 목재를 수입해 통나무집을 짓는다.', 
                isCorrect: false,
            ...
            { 
                text: '낮 더위를 피하기 위해 통풍이 잘되는 얇은 천 텐트를 짓는다.', 
                isCorrect: false,
            ...
            { 
                text: '주변 흙으로 두꺼운 벽을 쌓고, 창문은 작게 낸다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
    {
        ...
        choices: [
            ...
            { 
                text: '돌아온 영혼을 환영하며, 함께 즐거운 기억을 나눈다.', 
                isCorrect: true,
                successXp: 5,
            ...
            { 
                text: '산 자와 죽은 자의 영역은 다르므로, 위험을 피해 멀리 떨어져 있는다.', 
                isCorrect: false,
    ...
    },
    {
        ...
        choices: [
            ...
            { 
                text: '입구의 스카프로 머리와 어깨를 가리고 들어간다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '성스러운 장소이므로, 다른 종교처럼 모든 모자를 벗는다.', 
                isCorrect: false,
                successChance: 0.3,
            ...
            { 
                text: '바구니의 모자로 손과 얼굴을 닦아 몸을 정결히 한다.', 
                isCorrect: false,
            ...
            { 
                text: '신에게 머리 꼭대기를 보이지 않도록, 바구니의 모자를 쓴다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '최첨단 신소재로 만든 두꺼운 방한 비니를 쓴다.', 
                isCorrect: false,
                successChance: 0.3,
            ...
            { 
                text: '두꺼운 가죽으로 만들어 귀와 턱까지 덮는 모자를 쓴다.', 
                isCorrect: true,
                successXp: 5,
            ...
            { 
                text: '머리카락이 젖지 않게 방수가 되는 넓은 챙 모자를 쓴다.', 
                isCorrect: false,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '통풍이 잘되는 가벼운 밀짚모자로 더위를 피한다.', 
                isCorrect: false,
                failureText: '판단 착오였다. 밀짚모자는 햇볕은 잘 막아주었지만, 갑자기 쏟아진 폭우에 금방 망가져 버렸다. <span class="highlight-yellow">비에 대한 대책</span>이 전혀 되지 않았다.<br> ❤️ -4',
                failureDamage: 4
            },
            { 
                text: '나뭇잎으로 만든, 끝이 뾰족한 원뿔 형태의 모자를 쓴다.', 
                isCorrect: true,
                successXp: 5,
            ...
            { 
                text: '방수 기능이 있는 우비 모자를 뒤집어써 비에 대비한다.', 
                isCorrect: false,
                successChance: 0.3,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '가공하기 쉬운 얇은 나무판자를 이어 붙여 넓은 집을 짓는다.', 
                isCorrect: false,
            ...
            { 
                text: '나무를 땔감으로 삼고, 동굴을 파서 그 안에서 지낸다.', 
                isCorrect: false,
                successChance: 0.2,
            ...
            { 
                text: '두꺼운 통나무를 겹겹이 쌓아 벽을 만들고, 지붕은 경사지게 짓는다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '물에 쓸려가지 않게, 땅을 깊게 파고 튼튼한 벽돌집을 짓는다.', 
                isCorrect: false,
            ...
            { 
                text: '높은 나무 기둥을 땅에 박고, 그 위에 집을 지어 침수를 막는다.', 
                isCorrect: true,
                successXp: 5,
            ...
            { 
                text: '물에 뜨는 뗏목 기반을 만들고, 그 위에 가벼운 집을 짓는다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
   {
        ...
        choices: [
            { 
                text: '가장 비싼 부위로 만든 돼지고기 바비큐를 선물한다.', 
                isCorrect: false,
            ...
            { 
                text: '축제 분위기를 돋울 고급 샴페인(술)을 선물한다.', 
                isCorrect: false,
            ...
            { 
                text: '신선한 열대 과일과 견과류로 만든 디저트를 선물한다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '농사 성공을 축하하며, 귀한 소로 스테이크를 대접한다.', 
                isCorrect: false,
            ...
            { 
                text: '풍성하게 수확한 옥수수와 호박으로 채소 요리를 선보인다.', 
                isCorrect: false,
                successChance: 0.5,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '고기를 큰 덩어리째로, 구덩이를 파 장작불에 천천히 굽는다.', 
                isCorrect: false,
            ...
            { 
                text: '고기를 잘게 잘라 금속 꼬치에 꿰어, 작은 불에 돌려가며 굽는다.', 
                isCorrect: true,
                successXp: 5,
            ...
            { 
                text: '물을 사용해 고기를 끓이고, 주변 풀을 넣어 국을 만든다.', 
                isCorrect: false,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '더운 날씨에 기운을 돋울 영양가 높은 소고기 스테이크를 가져간다.', 
                isCorrect: false,
            ...
            { 
                text: '다양한 향신료를 사용해 만든 닭고기 카레를 가져간다.', 
                isCorrect: false,
                successChance: 0.7,
            ...
            { 
                text: '신선한 채소와 렌틸콩, 향신료를 넣은 채식 카레를 가져간다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
    {
        ...
        choices: [
            ...
            { 
                text: '재료를 곱게 갈아 가루로 만든 뒤, 화덕에서 빵으로 굽는다.', 
                isCorrect: false,
            ...
            { 
                text: '재료를 푹 삶은 뒤, 절구에 넣고 찧어 쫀득한 반죽으로 만든다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
    {
        ...
        choices: [
            ...
            { 
                text: '이 현상을 즐길 수 있는 대규모 예술 축제를 연다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '개인의 자유를 최우선으로, 모든 이름을 허용한다.', 
                isCorrect: false,
            ...
            { 
                text: '공동체 안정을 위해, 지정된 이름 목록 외에는 모두 금지한다.', 
                isCorrect: false,
            ...
            { 
                text: '기본 목록을 제공하고, 새 이름은 아동 복지 기준으로 심사한다.', 
                isCorrect: true,
                successXp: 5,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '강한 정신력으로 버티며, 물을 마시면서 계속 일한다.', 
                isCorrect: false,
            ...
            { 
                text: '가장 더운 시간에는 쉬고, 서늘해지면 다시 일한다.', 
                isCorrect: true,
                successXp: 5,
            ...
            { 
                text: '나무 그늘로 자리를 옮겨, 느린 속도로 계속 일한다.', 
                isCorrect: false,
                successChance: 0.3,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '땀 증발을 위해, 피부를 많이 노출하는 반소매와 반바지를 입는다.', 
                isCorrect: false,
            ...
            { 
                text: '햇빛을 반사하는 흰색의, 온몸을 덮는 헐렁한 옷을 입는다.', 
                isCorrect: true,
            ...
            { 
                text: '열을 잘 흡수하는 검은색의 몸에 딱 붙는 옷을 입는다.', 
                isCorrect: false,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '24시간 운영을 위해, 직원을 2명 고용해 교대로 가게를 지킨다.', 
                isCorrect: false,
            ...
            { 
                text: '치안을 믿고, 돈통만 놓아둔 무인 가판대를 설치한다.', 
                isCorrect: false,
            ...
            { 
                text: '직원 없이 24시간 작동하는 자동판매기를 설치한다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '공동체 의식을 바탕으로, 모든 주민을 동원해 양동이로 물을 퍼낸다.', 
                isCorrect: false,
            ...
            { 
                text: '수많은 말을 동원하여, 말이 끄는 힘으로 펌프를 돌린다.', 
                isCorrect: false,
                successChance: 0.2,
            ...
            { 
                text: '큰 날개가 달린 기계를 만들어, 바람의 힘으로 펌프를 돌린다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '각자 자신의 오두막에서, 화롯불에 의지하며 외부 활동을 줄인다.', 
                isCorrect: false,
            ...
            { 
                text: '마을 중앙에 큰 모닥불을 피워, 다 함께 온기를 쬐고 이야기한다.', 
                isCorrect: false,
                successChance: 0.2,
            ...
            { 
                text: '단열된 작은 나무 방을 만들어, 달군 돌로 온도를 높여 함께 사용한다.', 
                isCorrect: true,
        ...
        choices: [
            { 
                text: '강력한 이웃 국가와 군사 동맹을 맺어 안보를 보장받는다.', 
                isCorrect: false,
            ...
            { 
                text: '이웃을 자극하지 않기 위해, 군대를 해산하고 비무장 중립을 선언한다.', 
                isCorrect: false,
                successChance: 0.1,
            ...
            { 
                text: '알프스 산맥을 요새로 만들고, 모든 시민이 군인이 되어 저항한다.', 
                isCorrect: true,
    ...
    },  
    {
        ...
        choices: [
            { 
                text: '쌀을 포기하고, 산비탈에서 잘 자라는 다른 작물을 찾는다.', 
                isCorrect: false,
                successChance: 0.3,
            ...
            { 
                text: '산비탈을 깎아 수평의 층계를 만들고, 돌벽을 쌓아 물을 가둔다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '최신 기술로, 오토바이 배달원 네트워크를 이용해 개별 배송한다.', 
                isCorrect: false,
            ...
            { 
                text: '도심에 대형 급식 시설을 짓고, 다양한 집밥 스타일 메뉴를 제공한다.', 
                isCorrect: false,
                successChance: 0.2,
            ...
            { 
                text: '교통체증을 피해 정시성 높은 통근 열차로 옮기고, 인력으로 배달한다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '목재를 주재료로, 통풍을 위해 창문을 크게 낸 집을 짓는다.', 
                isCorrect: false,
            ...
            { 
                text: '주변 화산암을 이용하되, 열 흡수를 위해 어두운 색으로 짓는다.', 
                isCorrect: false,
                successChance: 0.2,
            ...
            { 
                text: '화산암 벽에 하얀 칠을 하고, 지붕은 둥근 돔 형태로 짓는다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '화산암을 채굴하여, 연료가 될 만한 광물을 찾는다.', 
                isCorrect: false,
            ...
            { 
                text: '떠내려온 유목이나 관목을 모아, 각 집 화로에서 아껴 쓴다.', 
                isCorrect: false,
                successChance: 0.2,
            ...
            { 
                text: '땅에서 솟는 온천수와 증기를 파이프로 연결해 각 가정에 공급한다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '안정성을 위해 바닥이 깊은 작은 돛단배를 사용한다.', 
                isCorrect: false,
            ...
            { 
                text: '노를 젓지 않도록, 프로펠러가 달린 작은 모터보트를 사용한다.', 
                isCorrect: false,
                successChance: 0.3,
            ...
            { 
                text: '바닥이 평평하고, 폭이 좁고 긴 배를 긴 노 하나로 젓는다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '수백 km 떨어진 도시에서 비싼 목재를 사서 운반해온다.', 
                isCorrect: false,
            ...
            { 
                text: '강둑이나 언덕 측면을 파고 들어가, 비바람만 막는 동굴집을 만든다.', 
                isCorrect: false,
                successChance: 0.4,
            ...
            { 
                text: '풀뿌리가 엉킨 흙을 벽돌처럼 잘라내어, 쌓아 올려 벽을 만든다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '바닥 온기를 등지고 서서 생활하며, 침대 위에서 잔다.', 
                isCorrect: false,
            ...
            { 
                text: '차가운 벽에 의자를 붙여 앉고, 해먹을 설치하여 잔다.', 
                isCorrect: false,
            ...
            { 
                text: '바닥에 방석을 깔고 앉아 생활하고, 바닥에 이불을 깔고 잔다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '최첨단 반도체 공장을 유치해, 막대한 부와 일자리를 창출한다.', 
                isCorrect: false,
            ...
            { 
                text: '산 전체를 깎아 거대한 스키 리조트를 짓고, 관광객을 유치한다.', 
                isCorrect: false,
                successChance: 0.2,
            ...
            { 
                text: '자연을 훼손 않는 소규모 생태 관광을 육성하고, 수익은 복지로 분배한다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '유청을 가축에게 먹여, 고기 질을 높이는 사료로 활용한다.', 
                isCorrect: false,
                successChance: 0.4,
            ...
            { 
                text: '신선함을 유지하기 위해, 차가운 계곡물에 담가 음료수로 보관한다.', 
                isCorrect: false,
            ...
            { 
                text: '큰 솥에 넣고, 수분이 날아가 갈색이 될 때까지 오래 졸인다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '몸을 최대한 가릴 수 있는 두껍고 긴 옷을 입는다.', 
                isCorrect: false,
            ...
            { 
                text: '생존에 필수적인 물을 아껴, 하루에 한 번씩 몸을 씻는다.', 
                isCorrect: false,
            ...
            { 
                text: '주변 붉은 흙을 갈아, 동물 기름과 섞어 온몸에 바른다.', 
                isCorrect: true,
    ...
    },
    {
        ...
        choices: [
            ...
            { 
                text: '소리 없이 나무 위로 올라가, 가까운 거리에서 창으로 사냥한다.', 
                isCorrect: false,
                successChance: 0.1,
    ...
    },
    {
        ...
        choices: [
            ...
            { 
                text: '농장주의 신뢰를 얻기 위해, 모든 훈련을 포기하고 농사일에 전념한다.', 
                isCorrect: false,
                successChance: 0.1,
    ...
    },
    {
        ...
        choices: [
            { 
                text: '강 전체를 가로지르는 거대한 그물로 바닥까지 훑어 물고기를 잡는다.', 
                isCorrect: false,
                successChance: 0.2,
            ...
            { 
                text: '강물에 독성이 있는 풀을 풀어, 기절해 떠오르는 물고기를 건져낸다.', 
                isCorrect: false,
            ...
            { 
                text: '물고기 잡는 새를 길들여, 나를 위해 물고기를 잡도록 훈련시킨다.', 
                isCorrect: true,
