const SITUATIONS = [
    ...
    },
   {
    ...
    },
    {
        ...
        choices: [
            ...
            { 
                ...
                isCorrect: false,
                successChance: 0.5,
                successText: '채소 요리는 훌륭했지만, 잔치의 중심이 될 <span class="highlight-yellow">푸짐한 고기 요리가 없어</span> 모두 아쉬워했다. 잔치는 사람들의 기대를 완전히 채워주지는 못했다.',
                failureText: '채소 요리만 내놓자 손님들은 크게 실망했다. 모두가 기다렸던 것은 <span class="highlight-yellow">든든한 고기 요리</span>였다. 잔치의 가장 중요한 부분을 놓쳐 분위기가 어색해졌다.<br> ❤️ -3',
                failureDamage: 3
            },
            { 
                text: '야생 날짐승 구이', 
    ...
    { // ID 14, 15 삭제됨
        ...
        image: 'images/situation_16.png', // ID 14, 15 삭제됨
    ...
    },
    {
        ...
        choices: [
            ...
            { 
                ...
                isCorrect: true,
                successText: '천재적인 생각이다. 복잡한 도로를 피한 당신의 배달 시스템은 매일 수십만 개의 도시락을 <span class="highlight-yellow">정확한 시간에, 뜨거운 상태로</span> 배달했다. 당신의 사업은 뭄바이 직장인들의 점심을 책임지는 도시의 중요한 부분이 되었다.<br>✨ +{xpGained}',
                info: {
    ...
    { // ID 29 삭제됨
        ...
        image: 'images/situation_30.png', // ID 29 삭제됨
